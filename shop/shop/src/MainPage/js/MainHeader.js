        ...
        <div class="web-main-tab-collapse">
          <div class="web-collapse-tab-top">
            <div class="collapse-tab-item">
              <div class="tab-item">피자</div>
              <Link to="/pizza">
                <div class="tab-item">전체피자</div>
              </Link>
              <div class="tab-item">스페셜반반피자</div>
              <div class="tab-item">세트메뉴</div>
              <div class="tab-item">하프앤하프</div>
            </div>
            <div class="collapse-tab-item">
              <div class="tab-item">사이드메뉴</div>
            </div>
            <div class="collapse-tab-item">
              <div class="tab-item">멤버십˙제휴할인</div>
              <div class="tab-item">멤버십 혜택</div>
              <div class="tab-item">통신사 제휴 할인</div>
            </div>
            <div class="collapse-tab-item">
              <div class="tab-item">이벤트</div>
            </div>
            <div class="collapse-tab-item">
              <div class="tab-item">매장찾기</div>
          ...
          <div class="web-collapse-tab-middle">
            <span class="tab-middle-item">회사소개</span>
            <span class="tab-middle-item">가맹문의</span>
            <span class="tab-middle-item">고객센터</span>
            <span class="tab-middle-item">단체주문</span>
            <img
