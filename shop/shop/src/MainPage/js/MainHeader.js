...
function MainHeader()
{
    const [isTabCollapseVisible, setTabCollapseVisible] = useState(false);

    const toggleTabCollapse = () => {
        setTabCollapseVisible(!isTabCollapseVisible);
    };
    return(
        <div class = "header_layout"> 
            <div class = "main_top">
                <div class = "top_left">
                    <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADQAAAAhAQMAAACsrRqAAAAABlBMVEX///8AAABVwtN+AAAAAnRSTlP/AOW3MEoAAAAUSURBVHicY2DAAf6DwQea0YPMXgCZ+6XxJRwbQwAAAABJRU5ErkJggg==" class="web-icon-menu" onClick={toggleTabCollapse}/>
